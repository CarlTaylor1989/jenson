                  	...
                  	<div class="album-artwork">                                                
                        ...
                        <div class="album-info">
                                ...
                                <div class="album-buybuttons">
                                        ...
                                        <?php
                                        if ($amazon){ ?>                  	                              
                                                <form method="POST" action="<?php echo $amazon; ?>">
                                                        <input type="submit" class="button1 buy-amazon" value="<?php _e('AMAZON', 'gxg_textdomain') ?>">
                                                </form>  
                                        <?php }
                
                                        if ($itunes){ ?>              
                                                <form method="POST" action="<?php echo $itunes; ?>">
                                                        <input type="submit" class="button1 buy-itunes" value="<?php _e('iTUNES', 'gxg_textdomain') ?>">
                                                </form>   
                                        <?php }
                                        
                                        if ($buy_other){ ?>              
                                                <form method="POST" action="<?php echo $buy_other; ?>">
                                                        <input type="submit" class="button1 buy-other" value="<?php echo $buy_other_text; ?>">
                                                </form>   
                                        <?php }
                                        ?>
                                ...
                                <div class="audioplayer-mobile">
                                        ...
                                        <div id='playlist'>JW Player</div>
                                                ...
                                                jwplayer('playlist').setup({
                                                        ...
                                                        'skin': '<?php bloginfo('template_directory'); ?>/jwplayer/soundboard_playlist.zip',
                                                        'skin': '<?php bloginfo('template_directory'); ?>/jwplayer/soundboard_playlist/soundboard.xml',
                                                        'controlbar': 'top',
                                                        'repeat': 'always',
